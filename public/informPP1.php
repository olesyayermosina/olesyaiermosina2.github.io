        ...
        <div class="inside">
            <div class="texts">
                ...
                <p>
                    ...
                    /
                    <a href="?page=containerPP" class="insider">
                        ПП-торти
                    </a>
                </p>
            </div>
            <div class="goods">
                <div class="good">
                    <div class="goodImg">
                        ...
                        <img src="img/ppCakeBig1.jpg" alt="oneGood" class="goodjpg">

                    </div>
                    <div class="goodText">
                        <h3>500 грн/кг</h3>
                        <p>Пряні коржі, подрібнений волоський горіх, шматочки ананаса і ніякого присмаку моркви. Вона
                            дає лише текстуру і м'якість. Всі коржики змащені кремчізом.</p>
