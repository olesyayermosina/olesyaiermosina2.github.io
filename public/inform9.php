            ...
            <div class="goods">
                <div class="good">
                    <div class="goodImg">
                        ...
                        <img src="img/clCakeB9.jpg" alt="oneGood" class="goodjpg">

                    </div>
                    <div class="goodText">
                        <h3>390 грн/кг</h3>
                        <p>Дуже шоколадні мокрі коржі, які тануть у роті, груша шматочками, трохи чарівного сирного
                            крему і наша домашня солона карамель, яку ми самі варимо для вас</p>
